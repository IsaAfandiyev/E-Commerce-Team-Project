    ...
    return <>
        <div className={styles.container}>
            ...
            <div className={styles.right}>
                ...
                <div className={styles.text}>Lorem ipsum dolor sit amet consectetur. Nec sit enim tellus faucibus bibendum ullamcorper. Phasellus tristique aenean at lorem sed scelerisque.</div>
